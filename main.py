...
class Application:
    ...
    def __init__(self):
        ...
        self.root.geometry("1000x600")  # Adjust the window size for better fit on a 14-inch screen

        self.panel = tk.Label(self.root)
        self.panel.place(x=50, y=3, width=400, height=480)  # Adjust the position and dimensions of panel 1

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=500, y=75, width=300, height=300)  # Adjust the position and dimensions of panel 2
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread(image_path)("C:\\Users\\91842\\OneDrive\\Desktop\\SignLanguage To Speech Conversion\\white.jpg")
    
    # Resize the 'white' image to a shape of (400, 400)
    ...
    # Continue with your code...
                ...
                #"C:\\Users\\HP\\Desktop\\PROJECTS\\SignLanguage To Text and Speech Conversion\\white.jpg"
